...
1. Should playlists and prompts be saved in the DB for user history?  
2. Should Ollama run on the same host as Django or be containerized separately?  
3. Should recommendations be cached per user prompt?  
