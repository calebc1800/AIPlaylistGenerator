...
class ListeningSuggestionServiceTests(TestCase):
    ...
    def test_generate_suggestions_with_profile_data(self, mock_summary, mock_breakdown):
        ...
        mock_summary.return_value = {"top_genre": "alt-pop", "avg_novelty": 82, "total_playlists": 3}
        profile_cache = {
            "source": "top_tracks",
            "genre_buckets": {
        ...
        prompts = generate_listening_suggestions("user123", profile_cache=profile_cache, max_prompts=9)
